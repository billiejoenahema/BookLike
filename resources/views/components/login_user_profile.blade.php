<div class="card shadow-sm mb-4" id="userProfileCard">
  <div class="d-sm-inline-flex">
    ...
    <div id="profile-edit-button">
      <a class="btn text-white p-1"
        href="{{ url('users/' .$login_user->id .'/edit') }}" role="button"
        id="editButton" data-toggle="tooltip" data-placement="top"
        title="プロフィール編集"><i class="fas fa-fx fa-lg fa-user-edit"></i></a>
    </div>
    <div class="
                col-12 col-sm-4
                pt-3
    ...
    <div class="mt-3 mb-3">
      <div class="float-left mr-3 w-25 h-25 text-center">
        ...
        <a href="{{ $book->url }} " target="_blank" rel="noopener"
          title="Amazonサイトへ移動"><i class="fab fa-amazon"></i>
          Amazon</a>
      </div>
      <h5>{{ $book->title }}</h5>
      <span
