        ...
        <div class="card mb-3">
          <div class="d-flex p-2">
            <div class="d-flex flex-column p-2 mr-2">
              <img src="{{ $image_url ?? asset('images/NoImage.png') }}"
            ...
            <div class="col-md-8 d-flex flex-column text-left p-2">
              ...
              <ul class="list-unstyled">
                ...
                <li class="list-item">評価：<label for="ratings"
                    class="ratings-value">3</label>
                  <div class="d-flex">
                    <div class="flex-row text-mango lead border py-1 px-3"
                      id="ratings" data-ratings="3" title="クリックして選択">
        ...
        <div class="form-group">
          ...
          <div class="col-12 p-0">
            ...
            <textarea id="textarea"
              ...
              name="text" autocomplete="text" rows="6"
          ...
          <div class="form-group row mb-0">
            <div class="col-12 text-right">
              ...
              <button id="postButton" type="button"
                onclick="categorySelectValidate()"
