  ...
  <div class="card-body p-3">
    <div class="form-group mb-3">
      ...
      <div class="d-flex flex-row p-0 mt-1">
        <form method="GET" action="{{ route('search_items') }}" class="
          form-inline
          d-flex
        ...
        ">
          ...
          " name="keyword" type="search" value="{{ $keyword }}"
            aria-label="書籍を再検索" required autocomplete="on" />
          @error('searchItems')
    ...
    <form method="GET" action="{{ route('reviews.post') }}">
      ...
      <button class="
        ...
        my-1
        shadow-sm
      " id="confirmButton" type="submit" disabled>
        確定
      </button>
    </form>
    <div class="mt-3">
      ...
      <div class="overflow-auto search-results">
        ...
        <div class="
          ...
          shadow-sm
          pointer
        " onClick="selectItem(this)" id="{{ $search_item->ASIN }}">
          <div>
          ...
          <div class="d-flex flex-column pl-2">
            <h6>
              {{ $search_item->ItemInfo->Title->DisplayValue ?? '' }}
            </h6>
            <ul class="list-unstyled">
              ...
              <li class="list-item">
                <object>
                  <a href="{{ $search_item->DetailPageURL }}" target="_blank"
