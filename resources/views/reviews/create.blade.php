    ...
    <div class="card-body form-group col-md-10 m-auto">
        <div class="py-3 d-flex-column m-0">
            ...
            <form method="GET" action="{{ route('search_items') }}" class="form-inline">
                @csrf
                <input class="form-control col-9 rounded-pill @error('keyword') is-invalid @enderror" name="keyword"
                    type="search" placeholder="キーワードを入力" aria-label="書籍を検索" required autocomplete="on" autofocus>
                @error('searchItems')
