                ...
                <ul class="navbar-nav text-blog">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right pb-0" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="{{ url('users/' .$login_user->id) }}"><i
                                    class="fas fa-user-cog fa-fw mr-2"></i>マイページ</a>
                            <a class="dropdown-item py-1" href="{{ url('reviews/create') }}"><i
                            ...
                            <a class="dropdown-item pt-1 pb-2" href="{{ url('users') }}"><i
                                    class="fas fa-users fa-fw mr-2"></i>ユーザー一覧</a>
                            <a class="dropdown-item border-top py-3" href="{{ route('logout') }}" onclick="event.preventDefault();
