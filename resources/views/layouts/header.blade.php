<nav
  class="navbar navbar-expand navbar-light sticky-top bg-imageColor shadow-sm py-0 mb-1">
  <div class="container">
    {{-- Brand Logo --}}
    <div class="dropdown">
      {{-- <a class="navbar-brand d-block text-white" href="{{ url('/') }}">
        --}}
        <a class="navbar-brand d-block text-white" href="#" role="button"
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
          <a class="dropdown-item" data-toggle="modal"
            data-target="#newPostModal" role="button" href="#">新規投稿</a>
