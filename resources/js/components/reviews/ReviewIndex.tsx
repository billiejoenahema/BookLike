...
const ReviewIndex: React.FC = () => {
  ...
  const fadeLayer: HTMLElement | null = document.getElementById('fadeLayer')
  ...
  const changeSelectBox = (selectedCategory: string) => {
  ...
  const selectCriteria = (e) => {
    const searchBooks: HTMLElement | null = document.getElementById('searchBooks') || document.getElementById('modalSearchBooks')
